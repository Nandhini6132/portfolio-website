  ...
  return (
    <>
      ...
      >
       ...
       <Box className='d-flex flex-wrap justify-content-center justify-content-lg-around ' sx={{gap:'35px'}}>
       {project?.map((pro,index)=>(
             <Card sx={{ width:'400px ', padding:'30px', marginBottom:'20px',background:'transparent', border:'none', borderRadius:'12px','&:hover':{boxShadow:'1px 5px 13px 3px #a75e9e', border:'none',backgroundColor: '#060505',
             borderRadius: '20px' } }}>
             <CardMedia
               component="img"
               alt="green iguana"
             ...
             />
             <CardContent>
               <Typography gutterBottom variant="h5" color={"white"} mt={3} component="div">
                 {pro.title}
               </Typography>
             ...
             <CardActions>
               <Button size="small" variant="contained" sx={{padding:'10px', borderRadius:'20px', color:'white', background:'#a75e9e;', '&:hover':{
                background:'#3b1e38'
               }}}> <Link href={pro.link} color="inherit" underline="none">Live Preview</Link> </Button>
               <Button size="small" variant="outlined" sx={{padding:'10px',borderRadius:'20px',color:'white'}}> <Link href={pro.code} color="inherit" underline="none">Check on GitHub</Link> </Button>
             </CardActions>
           </Card>
         ))}
       </Box>
