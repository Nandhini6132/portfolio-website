    ...
    <>
     <div    className="container pt-5" >
      ...
      <Box display={'flex'} justifyContent={'center'}>
       <form action="https://formspree.io/f/xqkrlqdw" method="POST" style={{width:'45%'}}>
       <div class="mb-5" >
          ...
          <input
            ...
            id="name"
            placeholder="Name"
            style={{backgroundColor:'transparent',height:'4rem',color:"white", border: '1px solid #509ead'}}
          />
        </div>
       <div class="mb-5" >
        ...
        <div class="mb-5">
          ...
          <textarea
            ...
            rows="3"
            name="message"
            style={{backgroundColor:'transparent',height:'10rem',color:"white",border: '1px solid #509ead'}}
          ></textarea>
        </div>
